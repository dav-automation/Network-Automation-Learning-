...
# Duplicate IPs at both sites
banner = '-' * 80
print()
print(banner)
print(f"Duplicate IPs at Houston and Atlanta sites:\n\n{houston_ips & atlanta_ips}")
print(banner)
print()
print(banner)
print(f"Duplicate IPs at all three sites:\n\n{houston_ips & atlanta_ips & chicago_ips} ")
print(banner)
print()
print(f"Chicago unique IP addresses:\n\n{chicago_ips.difference(atlanta_ips).difference(houston_ips)}")
print(banner)
print()